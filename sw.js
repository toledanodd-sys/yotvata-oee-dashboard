...
const CACHE = 'oee-shell-8a3b75c5a5';
const SHELL = ["./", "./index.html", "./styles.css", "./app.js", "./component.js", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/icon-maskable-512.png", "./icons/apple-touch-icon.png"];
